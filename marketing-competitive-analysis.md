# 🎯 Marketing Competitive Analysis Framework

**Skill ID:** `marketing-competitive-analysis`

**Purpose:** Research competitors and compare positioning, messaging, content strategy, and market presence. Use when analyzing a competitor, building battlecards, identifying content gaps, comparing feature messaging, or preparing competitive positioning recommendations.

---

## Table of Contents

1. [Competitive Research Methodology](#competitive-research-methodology)
2. [Messaging Comparison Frameworks](#messaging-comparison-frameworks)
3. [Content Gap Analysis](#content-gap-analysis)
4. [Positioning Strategy](#positioning-strategy)
5. [Battlecard Creation](#battlecard-creation)
...
- **Community forums:** Reddit, Discourse, Slack communities — user sentiment
...
1. **Create a new category:** if you do something genuinely different, define and own the category (high risk, high reward)
2. **Reframe the existing category:** change how buyers evaluate the category to favor your strengths
3. **Win the existing category:** compete directly on recognized criteria and out-execute
4. **Niche within the category:** own a specific segment, use case, or audience
...
Consider creating these companion documents:

- `battlecard-template.md` — One-page battlecard template
- `messaging-matrix.csv` — Spreadsheet for messaging comparison
- `positioning-map.png` — Visual 2x2 competitive positioning
- `content-audit.csv` — Content gap analysis spreadsheet
